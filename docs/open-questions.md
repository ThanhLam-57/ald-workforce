...
| -------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Đơn vị doanh số      | Đã xác nhận: doanh số Live là xu, không phải VND          | Lưu số xu nguyên; tiền thưởng/phạt/lương vẫn là VND; không tự quy đổi xu sang tiền        |
...
| Số công chuẩn        | Theo lịch công ty, branch hay từng nhân viên?             | Đã chọn số ngày thực của tháng trừ ngày nghỉ trong salary rule; cho override branch/month |
...
| Lương thử việc       | Tỷ lệ và ngày chuyển chính thức được tính thế nào?        | 85% trước `officialDate`, 100% từ ngày đó; chỉ áp dụng lương cứng, snapshot theo kỳ       |
...
- Adjustment hoặc sửa worksheet sau khi gửi luôn tạo working revision mới; kỳ đã
  publish không mutate và UI không bắt người dùng quản lý revision.
